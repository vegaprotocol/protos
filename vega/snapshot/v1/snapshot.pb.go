...
type RewardsPendingPayouts struct {
	...
	Payouts              []*RewardPendingPayout `protobuf:"bytes,2,rep,name=payouts,proto3" json:"payouts,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (m *RewardsPendingPayouts) GetPayouts() []*RewardPendingPayout {
	if m != nil {
		return m.Payouts
	}
	return nil
...
type RewardPendingPayout struct {
	...
	RewardPartyAmount    []*RewardPartyAmount `protobuf:"bytes,3,rep,name=reward_party_amount,json=rewardPartyAmount,proto3" json:"reward_party_amount,omitempty"`
...
func (m *RewardPendingPayout) Reset()         { *m = RewardPendingPayout{} }
func (m *RewardPendingPayout) String() string { return proto.CompactTextString(m) }
func (*RewardPendingPayout) ProtoMessage()    {}
func (*RewardPendingPayout) Descriptor() ([]byte, []int) {
	return fileDescriptor_cee6f703c00de307, []int{46}
}

func (m *RewardPendingPayout) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RewardPendingPayout.Unmarshal(m, b)
}
func (m *RewardPendingPayout) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RewardPendingPayout.Marshal(b, m, deterministic)
}
func (m *RewardPendingPayout) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RewardPendingPayout.Merge(m, src)
}
func (m *RewardPendingPayout) XXX_Size() int {
	return xxx_messageInfo_RewardPendingPayout.Size(m)
}
func (m *RewardPendingPayout) XXX_DiscardUnknown() {
	xxx_messageInfo_RewardPendingPayout.DiscardUnknown(m)
}

var xxx_messageInfo_RewardPendingPayout proto.InternalMessageInfo

func (m *RewardPendingPayout) GetFromAccount() string {
	if m != nil {
...
func (m *RewardPendingPayout) GetAsset() string {
	if m != nil {
		return m.Asset
	}
	return ""
...
func (m *RewardPendingPayout) GetRewardPartyAmount() []*RewardPartyAmount {
	if m != nil {
...
func (m *RewardPendingPayout) GetTotalReward() string {
	if m != nil {
...
func (m *RewardPendingPayout) GetEpochSeq() string {
	if m != nil {
		return m.EpochSeq
	}
	return ""
...
func (m *RewardPendingPayout) GetTimestamp() int64 {
	if m != nil {
		return m.Timestamp
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*RewardPendingPayout)(nil), "vega.snapshot.v1.RewardPendingPayout")
...
var fileDescriptor_cee6f703c00de307 = []byte{
	...
	,
}
