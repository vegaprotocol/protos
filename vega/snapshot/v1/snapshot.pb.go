...
var file_vega_snapshot_v1_snapshot_proto_msgTypes = make([]protoimpl.MessageInfo, 101)
var file_vega_snapshot_v1_snapshot_proto_goTypes = []interface{}{
	...
	(*MarketTracker)(nil),                      // 96: vega.snapshot.v1.MarketTracker
	(*SignerEventsPerAddress)(nil),             // 97: vega.snapshot.v1.SignerEventsPerAddress
	(*ERC20MultiSigTopologyVerified)(nil),      // 98: vega.snapshot.v1.ERC20MultiSigTopologyVerified
	(*ERC20MultiSigTopologyPending)(nil),       // 99: vega.snapshot.v1.ERC20MultiSigTopologyPending
	(*ProofOfWork)(nil),                        // 100: vega.snapshot.v1.ProofOfWork
	(*TransactionsAtHeight)(nil),               // 101: vega.snapshot.v1.TransactionsAtHeight
	(*v1.ChainEvent)(nil),                      // 102: vega.commands.v1.ChainEvent
	(*vega.Account)(nil),                       // 103: vega.Account
	(*vega.Asset)(nil),                         // 104: vega.Asset
	(*vega.Withdrawal)(nil),                    // 105: vega.Withdrawal
	(*vega.Deposit)(nil),                       // 106: vega.Deposit
	(*vega.BuiltinAssetDeposit)(nil),           // 107: vega.BuiltinAssetDeposit
	(*vega.ERC20Deposit)(nil),                  // 108: vega.ERC20Deposit
	(*vega.ERC20AssetList)(nil),                // 109: vega.ERC20AssetList
	(*v11.RecurringTransfers)(nil),             // 110: vega.checkpoint.v1.RecurringTransfers
	(*v11.ScheduledTransferAtTime)(nil),        // 111: vega.checkpoint.v1.ScheduledTransferAtTime
	(*vega.Delegation)(nil),                    // 112: vega.Delegation
	(*vega.Proposal)(nil),                      // 113: vega.Proposal
	(*vega.Vote)(nil),                          // 114: vega.Vote
	(*v12.StakeLinking)(nil),                   // 115: vega.events.v1.StakeLinking
	(*vega.Order)(nil),                         // 116: vega.Order
	(*vega.NetworkParameter)(nil),              // 117: vega.NetworkParameter
	(*vega.PriceMonitoringTrigger)(nil),        // 118: vega.PriceMonitoringTrigger
	(vega.Market_TradingMode)(0),               // 119: vega.Market.TradingMode
	(vega.AuctionTrigger)(0),                   // 120: vega.AuctionTrigger
	(*vega.AuctionDuration)(nil),               // 121: vega.AuctionDuration
	(*vega.Market)(nil),                        // 122: vega.Market
	(*v12.ValidatorUpdate)(nil),                // 123: vega.events.v1.ValidatorUpdate
	(*vega.RankingScore)(nil),                  // 124: vega.RankingScore
	(*vega.LiquidityProvision)(nil),            // 125: vega.LiquidityProvision
	(*v11.MarketActivityTracker)(nil),          // 126: vega.checkpoint.v1.MarketActivityTracker
...
var file_vega_snapshot_v1_snapshot_proto_depIdxs = []int32{
	...
	96,  // 47: vega.snapshot.v1.Payload.market_tracker:type_name -> vega.snapshot.v1.MarketTracker
	...
	98,  // 50: vega.snapshot.v1.Payload.erc20_multisig_topology_verified:type_name -> vega.snapshot.v1.ERC20MultiSigTopologyVerified
	99,  // 51: vega.snapshot.v1.Payload.erc20_multisig_topology_pending:type_name -> vega.snapshot.v1.ERC20MultiSigTopologyPending
	100, // 52: vega.snapshot.v1.Payload.proof_of_work:type_name -> vega.snapshot.v1.ProofOfWork
	...
	102, // 60: vega.snapshot.v1.EventForwarder.acked_events:type_name -> vega.commands.v1.ChainEvent
	103, // 61: vega.snapshot.v1.CollateralAccounts.accounts:type_name -> vega.Account
	104, // 62: vega.snapshot.v1.CollateralAssets.assets:type_name -> vega.Asset
	104, // 63: vega.snapshot.v1.ActiveAssets.assets:type_name -> vega.Asset
	104, // 64: vega.snapshot.v1.PendingAssets.assets:type_name -> vega.Asset
	105, // 65: vega.snapshot.v1.Withdrawal.withdrawal:type_name -> vega.Withdrawal
	106, // 66: vega.snapshot.v1.Deposit.deposit:type_name -> vega.Deposit
	107, // 67: vega.snapshot.v1.AssetAction.builtin_deposit:type_name -> vega.BuiltinAssetDeposit
	108, // 68: vega.snapshot.v1.AssetAction.erc20_deposit:type_name -> vega.ERC20Deposit
	109, // 69: vega.snapshot.v1.AssetAction.asset_list:type_name -> vega.ERC20AssetList
	...
	110, // 74: vega.snapshot.v1.BankingRecurringTransfers.recurring_tranfers:type_name -> vega.checkpoint.v1.RecurringTransfers
	111, // 75: vega.snapshot.v1.BankingScheduledTransfers.transfers_at_time:type_name -> vega.checkpoint.v1.ScheduledTransferAtTime
	112, // 76: vega.snapshot.v1.DelegationActive.delegations:type_name -> vega.Delegation
	112, // 77: vega.snapshot.v1.DelegationPending.delegations:type_name -> vega.Delegation
	112, // 78: vega.snapshot.v1.DelegationPending.undelegation:type_name -> vega.Delegation
	113, // 79: vega.snapshot.v1.ProposalData.proposal:type_name -> vega.Proposal
	114, // 80: vega.snapshot.v1.ProposalData.yes:type_name -> vega.Vote
	114, // 81: vega.snapshot.v1.ProposalData.no:type_name -> vega.Vote
	114, // 82: vega.snapshot.v1.ProposalData.invalid:type_name -> vega.Vote
	...
	113, // 85: vega.snapshot.v1.GovernanceNode.proposals:type_name -> vega.Proposal
	115, // 86: vega.snapshot.v1.StakingAccount.events:type_name -> vega.events.v1.StakeLinking
	39,  // 87: vega.snapshot.v1.StakingAccounts.accounts:type_name -> vega.snapshot.v1.StakingAccount
	116, // 88: vega.snapshot.v1.MatchingBook.buy:type_name -> vega.Order
	116, // 89: vega.snapshot.v1.MatchingBook.sell:type_name -> vega.Order
	117, // 90: vega.snapshot.v1.NetParams.params:type_name -> vega.NetworkParameter
	118, // 91: vega.snapshot.v1.PriceBound.trigger:type_name -> vega.PriceMonitoringTrigger
	...
	119, // 100: vega.snapshot.v1.AuctionState.mode:type_name -> vega.Market.TradingMode
	119, // 101: vega.snapshot.v1.AuctionState.default_mode:type_name -> vega.Market.TradingMode
	120, // 102: vega.snapshot.v1.AuctionState.trigger:type_name -> vega.AuctionTrigger
	121, // 103: vega.snapshot.v1.AuctionState.end:type_name -> vega.AuctionDuration
	120, // 104: vega.snapshot.v1.AuctionState.extension:type_name -> vega.AuctionTrigger
	53,  // 105: vega.snapshot.v1.EquityShare.lps:type_name -> vega.snapshot.v1.EquityShareLP
	122, // 106: vega.snapshot.v1.Market.market:type_name -> vega.Market
	...
	116, // 109: vega.snapshot.v1.Market.pegged_orders:type_name -> vega.Order
	116, // 110: vega.snapshot.v1.Market.expiring_orders:type_name -> vega.Order
	...
	123, // 133: vega.snapshot.v1.ValidatorState.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	86,  // 134: vega.snapshot.v1.ValidatorState.heartbeat_tracker:type_name -> vega.snapshot.v1.HeartbeatTracker
	124, // 135: vega.snapshot.v1.ValidatorState.ranking_score:type_name -> vega.RankingScore
	87,  // 136: vega.snapshot.v1.ValidatorPerformance.validator_perf_stats:type_name -> vega.snapshot.v1.PerformanceStats
	116, // 137: vega.snapshot.v1.LiquidityPartiesLiquidityOrders.orders:type_name -> vega.Order
	116, // 138: vega.snapshot.v1.LiquidityPartiesOrders.orders:type_name -> vega.Order
	125, // 139: vega.snapshot.v1.LiquidityProvisions.liquidity_provisions:type_name -> vega.LiquidityProvision
	95,  // 140: vega.snapshot.v1.FloatingPointConsensus.next_time_trigger:type_name -> vega.snapshot.v1.NextTimeTrigger
	126, // 141: vega.snapshot.v1.MarketTracker.market_activity:type_name -> vega.checkpoint.v1.MarketActivityTracker
	127, // 142: vega.snapshot.v1.SignerEventsPerAddress.events:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	97,  // 143: vega.snapshot.v1.ERC20MultiSigTopologyVerified.events_per_address:type_name -> vega.snapshot.v1.SignerEventsPerAddress
	128, // 144: vega.snapshot.v1.ERC20MultiSigTopologyVerified.threshold:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	127, // 145: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_signers:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	128, // 146: vega.snapshot.v1.ERC20MultiSigTopologyPending.pending_threshold_set:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	101, // 147: vega.snapshot.v1.ProofOfWork.tx_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	101, // 148: vega.snapshot.v1.ProofOfWork.tid_at_height:type_name -> vega.snapshot.v1.TransactionsAtHeight
	69,  // 149: vega.snapshot.v1.ProofOfWork.banned:type_name -> vega.snapshot.v1.BannedParty
