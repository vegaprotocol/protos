...
func (x *StakeTotalSupply) Reset() {
	*x = StakeTotalSupply{}
	if protoimpl.UnsafeEnabled {
		mi := &file_vega_chain_events_proto_msgTypes[20]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StakeTotalSupply) Descriptor() ([]byte, []int) {
	return file_vega_chain_events_proto_rawDescGZIP(), []int{20}
}
...
var file_vega_chain_events_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_vega_chain_events_proto_goTypes = []interface{}{
	...
	(*StakeTotalSupply)(nil),       // 20: vega.StakeTotalSupply
}
var file_vega_chain_events_proto_depIdxs = []int32{
	...
	20, // 16: vega.StakingEvent.total_supply:type_name -> vega.StakeTotalSupply
...
func file_vega_chain_events_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_vega_chain_events_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
