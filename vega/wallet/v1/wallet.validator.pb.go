...
func (this *SubmitTransactionRequest) Validate() error {
	...
	if oneOfNester, ok := this.GetCommand().(*SubmitTransactionRequest_LiquidityProvisionCancellation); ok {
	...
	if oneOfNester, ok := this.GetCommand().(*SubmitTransactionRequest_LiquidityProvisionAmendment); ok {
