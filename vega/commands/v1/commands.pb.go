...
var file_vega_commands_v1_commands_proto_rawDesc = []byte{
	...
	0x45, 0x52, 0x10, 0x03, 0x22, 0xea, 0x02, 0x0a, 0x08, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65,
	...
	0x74, 0x61, 0x72, 0x74, 0x45, 0x70, 0x6f, 0x63, 0x68, 0x12, 0x2e, 0x0a, 0x09, 0x65, 0x6e, 0x64,
	0x5f, 0x65, 0x70, 0x6f, 0x63, 0x68, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x76,
	0x65, 0x67, 0x61, 0x2e, 0x55, 0x69, 0x6e, 0x74, 0x36, 0x34, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52,
	0x08, 0x65, 0x6e, 0x64, 0x45, 0x70, 0x6f, 0x63, 0x68, 0x12, 0x16, 0x0a, 0x06, 0x66, 0x61, 0x63,
	...
	0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x22, 0x31, 0x0a, 0x0e, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c,
	...
	0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x49, 0x64, 0x42, 0x2e, 0x5a, 0x2c, 0x63, 0x6f, 0x64,
	0x65, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2e, 0x69,
	0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x76, 0x65, 0x67, 0x61, 0x2f, 0x63, 0x6f,
...
var file_vega_commands_v1_commands_proto_goTypes = []interface{}{
	...
	(*vega.Price)(nil),                     // 21: vega.Price
	(*vega.Timestamp)(nil),                 // 22: vega.Timestamp
	...
	(*vega.DispatchStrategy)(nil),          // 31: vega.DispatchStrategy
}
var file_vega_commands_v1_commands_proto_depIdxs = []int32{
	17, // 0: vega.commands.v1.OrderSubmission.side:type_name -> vega.Side
	18, // 1: vega.commands.v1.OrderSubmission.time_in_force:type_name -> vega.Order.TimeInForce
	19, // 2: vega.commands.v1.OrderSubmission.type:type_name -> vega.Order.Type
	20, // 3: vega.commands.v1.OrderSubmission.pegged_order:type_name -> vega.PeggedOrder
	21, // 4: vega.commands.v1.OrderAmendment.price:type_name -> vega.Price
	22, // 5: vega.commands.v1.OrderAmendment.expires_at:type_name -> vega.Timestamp
	18, // 6: vega.commands.v1.OrderAmendment.time_in_force:type_name -> vega.Order.TimeInForce
	23, // 7: vega.commands.v1.OrderAmendment.pegged_reference:type_name -> vega.PeggedReference
	24, // 8: vega.commands.v1.LiquidityProvisionSubmission.sells:type_name -> vega.LiquidityOrder
	24, // 9: vega.commands.v1.LiquidityProvisionSubmission.buys:type_name -> vega.LiquidityOrder
	24, // 10: vega.commands.v1.LiquidityProvisionAmendment.sells:type_name -> vega.LiquidityOrder
	24, // 11: vega.commands.v1.LiquidityProvisionAmendment.buys:type_name -> vega.LiquidityOrder
	25, // 12: vega.commands.v1.WithdrawSubmission.ext:type_name -> vega.WithdrawExt
	26, // 13: vega.commands.v1.ProposalSubmission.terms:type_name -> vega.ProposalTerms
	27, // 14: vega.commands.v1.ProposalSubmission.rationale:type_name -> vega.ProposalRationale
	28, // 15: vega.commands.v1.VoteSubmission.value:type_name -> vega.Vote.Value
	0,  // 16: vega.commands.v1.UndelegateSubmission.method:type_name -> vega.commands.v1.UndelegateSubmission.Method
	29, // 17: vega.commands.v1.Transfer.from_account_type:type_name -> vega.AccountType
	29, // 18: vega.commands.v1.Transfer.to_account_type:type_name -> vega.AccountType
	14, // 19: vega.commands.v1.Transfer.one_off:type_name -> vega.commands.v1.OneOffTransfer
	15, // 20: vega.commands.v1.Transfer.recurring:type_name -> vega.commands.v1.RecurringTransfer
	30, // 21: vega.commands.v1.RecurringTransfer.end_epoch:type_name -> vega.Uint64Value
	31, // 22: vega.commands.v1.RecurringTransfer.dispatch_strategy:type_name -> vega.DispatchStrategy
