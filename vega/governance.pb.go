...
type ProposalTerms struct {
	...
	// Types that are assignable to Enactment:
	//	*ProposalTerms_EnactmentTimestamp
	//	*ProposalTerms_EnactmentLastUpdate
	Enactment isProposalTerms_Enactment `protobuf_oneof:"enactment"`
...
func (m *ProposalTerms) GetEnactment() isProposalTerms_Enactment {
	if m != nil {
		return m.Enactment
	}
	return nil
...
func (x *ProposalTerms) GetEnactmentTimestamp() int64 {
	if x, ok := x.GetEnactment().(*ProposalTerms_EnactmentTimestamp); ok {
		return x.EnactmentTimestamp
	}
	return 0
}

func (x *ProposalTerms) GetEnactmentLastUpdate() int64 {
	if x, ok := x.GetEnactment().(*ProposalTerms_EnactmentLastUpdate); ok {
		return x.EnactmentLastUpdate
	}
	return 0
}
...
type isProposalTerms_Enactment interface {
	isProposalTerms_Enactment()
}

type ProposalTerms_EnactmentTimestamp struct {
	// Timestamp (Unix time in seconds) when proposal gets enacted (if passed),
	// constrained by `minEnact` and `maxEnact` network parameters
	EnactmentTimestamp int64 `protobuf:"varint,107,opt,name=enactment_timestamp,json=enactmentTimestamp,proto3,oneof"`
}

type ProposalTerms_EnactmentLastUpdate struct {
	// Last Update is the time duratuon in int64 that was last added to the timestamp field
	EnactmentLastUpdate int64 `protobuf:"varint,108,opt,name=enactment_last_update,json=enactmentLastUpdate,proto3,oneof"`
}

func (*ProposalTerms_EnactmentTimestamp) isProposalTerms_Enactment() {}

func (*ProposalTerms_EnactmentLastUpdate) isProposalTerms_Enactment() {}
...
var file_vega_governance_proto_rawDesc = []byte{
	...
	0x0b, 0x4e, 0x65, 0x77, 0x46, 0x72, 0x65, 0x65, 0x66, 0x6f, 0x72, 0x6d, 0x22, 0xd5, 0x04, 0x0a,
	...
	0x6e, 0x67, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x31, 0x0a, 0x14, 0x76,
	...
	,
	...
	0x65, 0x74, 0x48, 0x01, 0x52, 0x0c, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4d, 0x61, 0x72, 0x6b,
	...
	0x77, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x48, 0x01, 0x52, 0x09, 0x6e, 0x65, 0x77, 0x4d, 0x61,
	...
	0x65, 0x74, 0x65, 0x72, 0x48, 0x01, 0x52, 0x16, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4e, 0x65,
	...
	0x74, 0x48, 0x01, 0x52, 0x08, 0x6e, 0x65, 0x77, 0x41, 0x73, 0x73, 0x65, 0x74, 0x12, 0x36, 0x0a,
	...
	0x65, 0x65, 0x66, 0x6f, 0x72, 0x6d, 0x48, 0x01, 0x52, 0x0b, 0x6e, 0x65, 0x77, 0x46, 0x72, 0x65,
	...
	0x67, 0x61, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x73, 0x73, 0x65, 0x74, 0x48, 0x01,
	0x52, 0x0b, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x73, 0x73, 0x65, 0x74, 0x42, 0x0b, 0x0a,
	0x09, 0x65, 0x6e, 0x61, 0x63, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x42, 0x08, 0x0a, 0x06, 0x63, 0x68,
	0x61, 0x6e, 0x67, 0x65, 0x22, 0x5b, 0x0a, 0x11, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c,
	...
	0x6c, 0x22, 0x86, 0x03, 0x0a, 0x0e, 0x47, 0x6f, 0x76, 0x65, 0x72, 0x6e, 0x61, 0x6e, 0x63, 0x65,
	...
	,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x82, 0x04, 0x0a, 0x08, 0x50,
	...
	0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12, 0x29, 0x0a, 0x05, 0x74, 0x65,
	...
	0x74, 0x65, 0x72, 0x6d, 0x73, 0x12, 0x2b, 0x0a, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18,
	0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x13, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x50, 0x72, 0x6f,
	0x70, 0x6f, 0x73, 0x61, 0x6c, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x06, 0x72, 0x65, 0x61, 0x73,
	0x6f, 0x6e, 0x12, 0x23, 0x0a, 0x0d, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x5f, 0x64, 0x65, 0x74, 0x61,
	0x69, 0x6c, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x65, 0x72, 0x72, 0x6f, 0x72,
	0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x35, 0x0a, 0x09, 0x72, 0x61, 0x74, 0x69, 0x6f,
	...
	0x61, 0x6c, 0x65, 0x52, 0x09, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x65, 0x22, 0xae,
	...
	0x53, 0x10, 0x02, 0x2a, 0xcf, 0x0d, 0x0a, 0x0d, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c,
	...
	0x47, 0x45, 0x10, 0x17, 0x12, 0x36, 0x0a, 0x32, 0x50, 0x52, 0x4f, 0x50, 0x4f, 0x53, 0x41, 0x4c,
	0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x5f, 0x4d, 0x41, 0x52, 0x4b, 0x45, 0x54, 0x5f, 0x4d, 0x49,
	0x53, 0x53, 0x49, 0x4e, 0x47, 0x5f, 0x4c, 0x49, 0x51, 0x55, 0x49, 0x44, 0x49, 0x54, 0x59, 0x5f,
	0x43, 0x4f, 0x4d, 0x4d, 0x49, 0x54, 0x4d, 0x45, 0x4e, 0x54, 0x10, 0x18, 0x12, 0x2f, 0x0a, 0x2b,
	...
	,
	...
	0x45, 0x52, 0x53, 0x10, 0x28, 0x42, 0x22, 0x5a, 0x20, 0x63, 0x6f, 0x64, 0x65, 0x2e, 0x76, 0x65,
...
func file_vega_governance_proto_init() {
	...
	file_vega_governance_proto_msgTypes[13].OneofWrappers = []interface{}{
		(*ProposalTerms_EnactmentTimestamp)(nil),
		(*ProposalTerms_EnactmentLastUpdate)(nil),
