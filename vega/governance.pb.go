...
type NewFreeform struct {
	...
	// DEPRECATED The configuration of the new freeform
...
var file_vega_governance_proto_rawDesc = []byte{
	...
	0x6d, 0x42, 0x08, 0x0a, 0x06, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x22, 0x5b, 0x0a, 0x11, 0x50,
	...
	0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x22, 0x86, 0x03, 0x0a, 0x0e, 0x47, 0x6f, 0x76,
...
var file_vega_governance_proto_depIdxs = []int32{
	...
	19, // 31: vega.GovernanceData.proposal:type_name -> vega.Proposal
	20, // 32: vega.GovernanceData.yes:type_name -> vega.Vote
	20, // 33: vega.GovernanceData.no:type_name -> vega.Vote
	21, // 34: vega.GovernanceData.yes_party:type_name -> vega.GovernanceData.YesPartyEntry
	22, // 35: vega.GovernanceData.no_party:type_name -> vega.GovernanceData.NoPartyEntry
	...
	20, // 40: vega.GovernanceData.YesPartyEntry.value:type_name -> vega.Vote
	20, // 41: vega.GovernanceData.NoPartyEntry.value:type_name -> vega.Vote
