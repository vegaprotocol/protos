...
var file_vega_api_v1_core_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x06, 0x74, 0x78, 0x48, 0x61, 0x73, 0x68, 0x22, 0x14, 0x0a, 0x12, 0x47, 0x65,
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0xa1, 0x01, 0x0a, 0x16, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76,
	...
	0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x22, 0x13, 0x0a, 0x11, 0x53, 0x74, 0x61, 0x74, 0x69, 0x73,
	0x74, 0x69, 0x63, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x4d, 0x0a, 0x12, 0x53,
	...
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x2e, 0x61, 0x70, 0x69,
	0x2e, 0x76, 0x31, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x69, 0x73, 0x74, 0x69, 0x63, 0x73, 0x52, 0x0a,
	0x73, 0x74, 0x61, 0x74, 0x69, 0x73, 0x74, 0x69, 0x63, 0x73, 0x22, 0xe9, 0x0a, 0x0a, 0x0a, 0x53,
	...
	0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x18, 0x0a, 0x16, 0x4c, 0x61, 0x73, 0x74, 0x42, 0x6c,
	0x6f, 0x63, 0x6b, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x22, 0x31, 0x0a, 0x17, 0x4c, 0x61, 0x73, 0x74, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x48, 0x65, 0x69,
	...
	0x67, 0x68, 0x74, 0x32, 0xa9, 0x05, 0x0a, 0x0b, 0x43, 0x6f, 0x72, 0x65, 0x53, 0x65, 0x72, 0x76,
	...
	0x29, 0x5a, 0x27, 0x63, 0x6f, 0x64, 0x65, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x63, 0x6f, 0x6c, 0x2e, 0x69, 0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x76,
	0x65, 0x67, 0x61, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_vega_api_v1_core_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_vega_api_v1_core_proto_goTypes = []interface{}{
	...
	(*GetVegaTimeRequest)(nil),            // 10: vega.api.v1.GetVegaTimeRequest
	(*GetVegaTimeResponse)(nil),           // 11: vega.api.v1.GetVegaTimeResponse
	(*ObserveEventBusRequest)(nil),        // 12: vega.api.v1.ObserveEventBusRequest
	(*ObserveEventBusResponse)(nil),       // 13: vega.api.v1.ObserveEventBusResponse
	(*StatisticsRequest)(nil),             // 14: vega.api.v1.StatisticsRequest
	(*StatisticsResponse)(nil),            // 15: vega.api.v1.StatisticsResponse
	(*Statistics)(nil),                    // 16: vega.api.v1.Statistics
	(*LastBlockHeightRequest)(nil),        // 17: vega.api.v1.LastBlockHeightRequest
	(*LastBlockHeightResponse)(nil),       // 18: vega.api.v1.LastBlockHeightResponse
	(*v1.Transaction)(nil),                // 19: vega.commands.v1.Transaction
	(v11.BusEventType)(0),                 // 20: vega.events.v1.BusEventType
	(*v11.BusEvent)(nil),                  // 21: vega.events.v1.BusEvent
	(vega.ChainStatus)(0),                 // 22: vega.ChainStatus
}
var file_vega_api_v1_core_proto_depIdxs = []int32{
	19, // 0: vega.api.v1.SubmitTransactionRequest.tx:type_name -> vega.commands.v1.Transaction
	0,  // 1: vega.api.v1.SubmitTransactionRequest.type:type_name -> vega.api.v1.SubmitTransactionRequest.Type
	19, // 2: vega.api.v1.CheckTransactionRequest.tx:type_name -> vega.commands.v1.Transaction
	1,  // 3: vega.api.v1.SubmitRawTransactionRequest.type:type_name -> vega.api.v1.SubmitRawTransactionRequest.Type
	20, // 4: vega.api.v1.ObserveEventBusRequest.type:type_name -> vega.events.v1.BusEventType
	21, // 5: vega.api.v1.ObserveEventBusResponse.events:type_name -> vega.events.v1.BusEvent
	16, // 6: vega.api.v1.StatisticsResponse.statistics:type_name -> vega.api.v1.Statistics
	22, // 7: vega.api.v1.Statistics.status:type_name -> vega.ChainStatus
	...
	14, // 10: vega.api.v1.CoreService.Statistics:input_type -> vega.api.v1.StatisticsRequest
	17, // 11: vega.api.v1.CoreService.LastBlockHeight:input_type -> vega.api.v1.LastBlockHeightRequest
	10, // 12: vega.api.v1.CoreService.GetVegaTime:input_type -> vega.api.v1.GetVegaTimeRequest
	12, // 13: vega.api.v1.CoreService.ObserveEventBus:input_type -> vega.api.v1.ObserveEventBusRequest
	8,  // 14: vega.api.v1.CoreService.SubmitRawTransaction:input_type -> vega.api.v1.SubmitRawTransactionRequest
	5,  // 15: vega.api.v1.CoreService.SubmitTransaction:output_type -> vega.api.v1.SubmitTransactionResponse
	3,  // 16: vega.api.v1.CoreService.PropagateChainEvent:output_type -> vega.api.v1.PropagateChainEventResponse
	15, // 17: vega.api.v1.CoreService.Statistics:output_type -> vega.api.v1.StatisticsResponse
	18, // 18: vega.api.v1.CoreService.LastBlockHeight:output_type -> vega.api.v1.LastBlockHeightResponse
	11, // 19: vega.api.v1.CoreService.GetVegaTime:output_type -> vega.api.v1.GetVegaTimeResponse
	13, // 20: vega.api.v1.CoreService.ObserveEventBus:output_type -> vega.api.v1.ObserveEventBusResponse
	9,  // 21: vega.api.v1.CoreService.SubmitRawTransaction:output_type -> vega.api.v1.SubmitRawTransactionResponse
