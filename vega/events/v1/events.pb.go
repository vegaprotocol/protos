...
var file_vega_events_v1_events_proto_rawDesc = []byte{
	...
	0x61, 0x64, 0x22, 0xcf, 0x0b, 0x0a, 0x0c, 0x54, 0x78, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x45, 0x76,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x12, 0x4e, 0x0a, 0x10, 0x72, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x5f,
	0x73, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x18, 0x6e, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21,
	...
	0x74, 0x48, 0x00, 0x52, 0x0f, 0x72, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x53, 0x6e, 0x61, 0x70,
	0x73, 0x68, 0x6f, 0x74, 0x12, 0x7c, 0x0a, 0x20, 0x6c, 0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0xad, 0x1a, 0x0a, 0x08, 0x42,
...
var file_vega_events_v1_events_proto_depIdxs = []int32{
	...
	50, // 20: vega.events.v1.TxErrorEvent.restore_snapshot:type_name -> vega.commands.v1.RestoreSnapshot
	51, // 21: vega.events.v1.TxErrorEvent.liquidity_provision_cancellation:type_name -> vega.commands.v1.LiquidityProvisionCancellation
	52, // 22: vega.events.v1.TxErrorEvent.liquidity_provision_amendment:type_name -> vega.commands.v1.LiquidityProvisionAmendment
	53, // 23: vega.events.v1.TxErrorEvent.transfer:type_name -> vega.commands.v1.Transfer
	54, // 24: vega.events.v1.TxErrorEvent.cancel_transfer:type_name -> vega.commands.v1.CancelTransfer
	55, // 25: vega.events.v1.TxErrorEvent.announce_node:type_name -> vega.commands.v1.AnnounceNode
	56, // 26: vega.events.v1.TxErrorEvent.oracle_data_submission:type_name -> vega.commands.v1.OracleDataSubmission
	57, // 27: vega.events.v1.EpochEvent.action:type_name -> vega.EpochAction
	58, // 28: vega.events.v1.TransferResponses.responses:type_name -> vega.TransferResponse
	26, // 29: vega.events.v1.SettlePosition.trade_settlements:type_name -> vega.events.v1.TradeSettlement
	59, // 30: vega.events.v1.AuctionEvent.trigger:type_name -> vega.AuctionTrigger
	59, // 31: vega.events.v1.AuctionEvent.extension_trigger:type_name -> vega.AuctionTrigger
	0,  // 32: vega.events.v1.BusEvent.type:type_name -> vega.events.v1.BusEventType
	21, // 33: vega.events.v1.BusEvent.time_update:type_name -> vega.events.v1.TimeUpdate
	23, // 34: vega.events.v1.BusEvent.transfer_responses:type_name -> vega.events.v1.TransferResponses
	24, // 35: vega.events.v1.BusEvent.position_resolution:type_name -> vega.events.v1.PositionResolution
	60, // 36: vega.events.v1.BusEvent.order:type_name -> vega.Order
	61, // 37: vega.events.v1.BusEvent.account:type_name -> vega.Account
	62, // 38: vega.events.v1.BusEvent.party:type_name -> vega.Party
	63, // 39: vega.events.v1.BusEvent.trade:type_name -> vega.Trade
	64, // 40: vega.events.v1.BusEvent.margin_levels:type_name -> vega.MarginLevels
	65, // 41: vega.events.v1.BusEvent.proposal:type_name -> vega.Proposal
	66, // 42: vega.events.v1.BusEvent.vote:type_name -> vega.Vote
	67, // 43: vega.events.v1.BusEvent.market_data:type_name -> vega.MarketData
	68, // 44: vega.events.v1.BusEvent.node_signature:type_name -> vega.commands.v1.NodeSignature
	25, // 45: vega.events.v1.BusEvent.loss_socialization:type_name -> vega.events.v1.LossSocialization
	27, // 46: vega.events.v1.BusEvent.settle_position:type_name -> vega.events.v1.SettlePosition
	29, // 47: vega.events.v1.BusEvent.settle_distressed:type_name -> vega.events.v1.SettleDistressed
	69, // 48: vega.events.v1.BusEvent.market_created:type_name -> vega.Market
	70, // 49: vega.events.v1.BusEvent.asset:type_name -> vega.Asset
	30, // 50: vega.events.v1.BusEvent.market_tick:type_name -> vega.events.v1.MarketTick
	71, // 51: vega.events.v1.BusEvent.withdrawal:type_name -> vega.Withdrawal
	72, // 52: vega.events.v1.BusEvent.deposit:type_name -> vega.Deposit
	31, // 53: vega.events.v1.BusEvent.auction:type_name -> vega.events.v1.AuctionEvent
	73, // 54: vega.events.v1.BusEvent.risk_factor:type_name -> vega.RiskFactor
	74, // 55: vega.events.v1.BusEvent.network_parameter:type_name -> vega.NetworkParameter
	75, // 56: vega.events.v1.BusEvent.liquidity_provision:type_name -> vega.LiquidityProvision
	69, // 57: vega.events.v1.BusEvent.market_updated:type_name -> vega.Market
	76, // 58: vega.events.v1.BusEvent.oracle_spec:type_name -> oracles.v1.OracleSpec
	77, // 59: vega.events.v1.BusEvent.oracle_data:type_name -> oracles.v1.OracleData
	18, // 60: vega.events.v1.BusEvent.delegation_balance:type_name -> vega.events.v1.DelegationBalanceEvent
	17, // 61: vega.events.v1.BusEvent.validator_score:type_name -> vega.events.v1.ValidatorScoreEvent
	22, // 62: vega.events.v1.BusEvent.epoch_event:type_name -> vega.events.v1.EpochEvent
	32, // 63: vega.events.v1.BusEvent.validator_update:type_name -> vega.events.v1.ValidatorUpdate
	11, // 64: vega.events.v1.BusEvent.stake_linking:type_name -> vega.events.v1.StakeLinking
	16, // 65: vega.events.v1.BusEvent.reward_payout:type_name -> vega.events.v1.RewardPayoutEvent
	14, // 66: vega.events.v1.BusEvent.checkpoint:type_name -> vega.events.v1.CheckpointEvent
	34, // 67: vega.events.v1.BusEvent.key_rotation:type_name -> vega.events.v1.KeyRotation
	36, // 68: vega.events.v1.BusEvent.state_var:type_name -> vega.events.v1.StateVar
	78, // 69: vega.events.v1.BusEvent.network_limits:type_name -> vega.NetworkLimits
	8,  // 70: vega.events.v1.BusEvent.transfer:type_name -> vega.events.v1.Transfer
	33, // 71: vega.events.v1.BusEvent.ranking_event:type_name -> vega.events.v1.ValidatorRankingEvent
	12, // 72: vega.events.v1.BusEvent.erc20_multisig_signer_event:type_name -> vega.events.v1.ERC20MultiSigSignerEvent
	13, // 73: vega.events.v1.BusEvent.erc20_multisig_set_threshold_event:type_name -> vega.events.v1.ERC20MultiSigThresholdSetEvent
	5,  // 74: vega.events.v1.BusEvent.erc20_multisig_signer_added:type_name -> vega.events.v1.ERC20MultiSigSignerAdded
	7,  // 75: vega.events.v1.BusEvent.erc20_multisig_signer_removed:type_name -> vega.events.v1.ERC20MultiSigSignerRemoved
	28, // 76: vega.events.v1.BusEvent.position_state_event:type_name -> vega.events.v1.PositionStateEvent
	35, // 77: vega.events.v1.BusEvent.ethereum_key_rotation:type_name -> vega.events.v1.EthereumKeyRotation
