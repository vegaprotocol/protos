...
var file_vega_events_v1_events_proto_rawDesc = []byte{
	...
	0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x49,
	...
	0x09, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x3b, 0x0a, 0x0f, 0x54, 0x72, 0x61,
	...
	0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x22, 0xd5, 0x01, 0x0a, 0x0e, 0x53, 0x65, 0x74, 0x74, 0x6c,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x22, 0xdf, 0x02, 0x0a, 0x0f,
	...
	0x28, 0x04, 0x52, 0x09, 0x66, 0x72, 0x6f, 0x6d, 0x45, 0x70, 0x6f, 0x63, 0x68, 0x22, 0xb2, 0x02,
	...
	0x69, 0x67, 0x68, 0x74, 0x22, 0x4b, 0x0a, 0x08, 0x53, 0x74, 0x61, 0x74, 0x65, 0x56, 0x61, 0x72,
	...
	0x65, 0x22, 0xad, 0x1a, 0x0a, 0x08, 0x42, 0x75, 0x73, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x0e,
	...
	0x74, 0x2a, 0xbd, 0x0d, 0x0a, 0x0c, 0x42, 0x75, 0x73, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79,
	...
	0x54, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x2f, 0x12, 0x19, 0x0a, 0x15, 0x42, 0x55, 0x53, 0x5f,
	...
	0x01, 0x42, 0x2c, 0x5a, 0x2a, 0x63, 0x6f, 0x64, 0x65, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x70, 0x72,
...
var file_vega_events_v1_events_proto_goTypes = []interface{}{
	...
	(*v1.OrderSubmission)(nil),                   // 40: vega.commands.v1.OrderSubmission
	(*v1.OrderAmendment)(nil),                    // 41: vega.commands.v1.OrderAmendment
	(*v1.OrderCancellation)(nil),                 // 42: vega.commands.v1.OrderCancellation
	(*v1.ProposalSubmission)(nil),                // 43: vega.commands.v1.ProposalSubmission
	(*v1.VoteSubmission)(nil),                    // 44: vega.commands.v1.VoteSubmission
	(*v1.LiquidityProvisionSubmission)(nil),      // 45: vega.commands.v1.LiquidityProvisionSubmission
	(*v1.WithdrawSubmission)(nil),                // 46: vega.commands.v1.WithdrawSubmission
	(*v1.DelegateSubmission)(nil),                // 47: vega.commands.v1.DelegateSubmission
	(*v1.UndelegateSubmission)(nil),              // 48: vega.commands.v1.UndelegateSubmission
	(*v1.RestoreSnapshot)(nil),                   // 49: vega.commands.v1.RestoreSnapshot
	...
	(*v11.OracleSpec)(nil),                       // 75: oracles.v1.OracleSpec
	(*v11.OracleData)(nil),                       // 76: oracles.v1.OracleData
...
var file_vega_events_v1_events_proto_depIdxs = []int32{
	...
	40, // 10: vega.events.v1.TxErrorEvent.order_submission:type_name -> vega.commands.v1.OrderSubmission
	41, // 11: vega.events.v1.TxErrorEvent.order_amendment:type_name -> vega.commands.v1.OrderAmendment
	42, // 12: vega.events.v1.TxErrorEvent.order_cancellation:type_name -> vega.commands.v1.OrderCancellation
	43, // 13: vega.events.v1.TxErrorEvent.proposal:type_name -> vega.commands.v1.ProposalSubmission
	44, // 14: vega.events.v1.TxErrorEvent.vote_submission:type_name -> vega.commands.v1.VoteSubmission
	45, // 15: vega.events.v1.TxErrorEvent.liquidity_provision_submission:type_name -> vega.commands.v1.LiquidityProvisionSubmission
	46, // 16: vega.events.v1.TxErrorEvent.withdraw_submission:type_name -> vega.commands.v1.WithdrawSubmission
	47, // 17: vega.events.v1.TxErrorEvent.delegate_submission:type_name -> vega.commands.v1.DelegateSubmission
	48, // 18: vega.events.v1.TxErrorEvent.undelegate_submission:type_name -> vega.commands.v1.UndelegateSubmission
	49, // 19: vega.events.v1.TxErrorEvent.restore_snapshot:type_name -> vega.commands.v1.RestoreSnapshot
	...
	75, // 57: vega.events.v1.BusEvent.oracle_spec:type_name -> oracles.v1.OracleSpec
	76, // 58: vega.events.v1.BusEvent.oracle_data:type_name -> oracles.v1.OracleData
