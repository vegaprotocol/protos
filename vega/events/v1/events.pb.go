...
type TradeSettlement struct {
	...
	// Size of trade settlement in the market position decimal places
...
func (x *TradeSettlement) GetSize() string {
	if x != nil {
		return x.Size
	}
	return ""
...
var file_vega_events_v1_events_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0xd6, 0x02, 0x0a, 0x13,
	...
	0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0xa8, 0x0a, 0x0a, 0x0c, 0x54, 0x78, 0x45,
	...
	0x72, 0x65, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x12, 0x7c, 0x0a, 0x20, 0x6c, 0x69,
	...
	0x73, 0x66, 0x65, 0x72, 0x42, 0x0d, 0x0a, 0x0b, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x22, 0x2a, 0x0a, 0x0a, 0x54, 0x69, 0x6d, 0x65, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x28, 0x09, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x72, 0x69, 0x63,
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x22, 0xac,
	...
	0x72, 0x22, 0xdf, 0x02, 0x0a, 0x0f, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x55,
	...
	0x6f, 0x63, 0x68, 0x22, 0xb2, 0x02, 0x0a, 0x15, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f,
	...
	0x65, 0x22, 0xaf, 0x15, 0x0a, 0x08, 0x42, 0x75, 0x73, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x0e,
	...
	0x65, 0x6e, 0x74, 0x2a, 0xa9, 0x0b, 0x0a, 0x0c, 0x42, 0x75, 0x73, 0x45, 0x76, 0x65, 0x6e, 0x74,
	...
	0x4b, 0x49, 0x4e, 0x47, 0x10, 0x29, 0x12, 0x19, 0x0a, 0x15, 0x42, 0x55, 0x53, 0x5f, 0x45, 0x56,
	...
	0x2c, 0x5a, 0x2a, 0x63, 0x6f, 0x64, 0x65, 0x2e, 0x76, 0x65, 0x67, 0x61, 0x70, 0x72, 0x6f, 0x74,
...
var file_vega_events_v1_events_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_vega_events_v1_events_proto_goTypes = []interface{}{
	...
	(*ValidatorRankingEvent)(nil),             // 26: vega.events.v1.ValidatorRankingEvent
	(*KeyRotation)(nil),                       // 27: vega.events.v1.KeyRotation
	(*StateVar)(nil),                          // 28: vega.events.v1.StateVar
	(*BusEvent)(nil),                          // 29: vega.events.v1.BusEvent
	(vega.AccountType)(0),                     // 30: vega.AccountType
	(*vega.Uint64Value)(nil),                  // 31: vega.Uint64Value
	(*v1.OrderSubmission)(nil),                // 32: vega.commands.v1.OrderSubmission
	(*v1.OrderAmendment)(nil),                 // 33: vega.commands.v1.OrderAmendment
	(*v1.OrderCancellation)(nil),              // 34: vega.commands.v1.OrderCancellation
	(*v1.ProposalSubmission)(nil),             // 35: vega.commands.v1.ProposalSubmission
	(*v1.VoteSubmission)(nil),                 // 36: vega.commands.v1.VoteSubmission
	(*v1.LiquidityProvisionSubmission)(nil),   // 37: vega.commands.v1.LiquidityProvisionSubmission
	(*v1.WithdrawSubmission)(nil),             // 38: vega.commands.v1.WithdrawSubmission
	(*v1.DelegateSubmission)(nil),             // 39: vega.commands.v1.DelegateSubmission
	(*v1.UndelegateSubmission)(nil),           // 40: vega.commands.v1.UndelegateSubmission
	(*v1.RestoreSnapshot)(nil),                // 41: vega.commands.v1.RestoreSnapshot
	(*v1.LiquidityProvisionCancellation)(nil), // 42: vega.commands.v1.LiquidityProvisionCancellation
	(*v1.LiquidityProvisionAmendment)(nil),    // 43: vega.commands.v1.LiquidityProvisionAmendment
	(*v1.Transfer)(nil),                       // 44: vega.commands.v1.Transfer
	(*v1.CancelTransfer)(nil),                 // 45: vega.commands.v1.CancelTransfer
	(vega.EpochAction)(0),                     // 46: vega.EpochAction
	(*vega.TransferResponse)(nil),             // 47: vega.TransferResponse
	(vega.AuctionTrigger)(0),                  // 48: vega.AuctionTrigger
	(*vega.Order)(nil),                        // 49: vega.Order
	(*vega.Account)(nil),                      // 50: vega.Account
	(*vega.Party)(nil),                        // 51: vega.Party
	(*vega.Trade)(nil),                        // 52: vega.Trade
	(*vega.MarginLevels)(nil),                 // 53: vega.MarginLevels
	(*vega.Proposal)(nil),                     // 54: vega.Proposal
	(*vega.Vote)(nil),                         // 55: vega.Vote
	(*vega.MarketData)(nil),                   // 56: vega.MarketData
	(*v1.NodeSignature)(nil),                  // 57: vega.commands.v1.NodeSignature
	(*vega.Market)(nil),                       // 58: vega.Market
	(*vega.Asset)(nil),                        // 59: vega.Asset
	(*vega.Withdrawal)(nil),                   // 60: vega.Withdrawal
	(*vega.Deposit)(nil),                      // 61: vega.Deposit
	(*vega.RiskFactor)(nil),                   // 62: vega.RiskFactor
	(*vega.NetworkParameter)(nil),             // 63: vega.NetworkParameter
	(*vega.LiquidityProvision)(nil),           // 64: vega.LiquidityProvision
	(*v11.OracleSpec)(nil),                    // 65: oracles.v1.OracleSpec
	(*v11.OracleData)(nil),                    // 66: oracles.v1.OracleData
	(*vega.NetworkLimits)(nil),                // 67: vega.NetworkLimits
}
var file_vega_events_v1_events_proto_depIdxs = []int32{
	30, // 0: vega.events.v1.Transfer.from_account_type:type_name -> vega.AccountType
	30, // 1: vega.events.v1.Transfer.to_account_type:type_name -> vega.AccountType
	...
	31, // 5: vega.events.v1.RecurringTransfer.end_epoch:type_name -> vega.Uint64Value
	...
	32, // 8: vega.events.v1.TxErrorEvent.order_submission:type_name -> vega.commands.v1.OrderSubmission
	33, // 9: vega.events.v1.TxErrorEvent.order_amendment:type_name -> vega.commands.v1.OrderAmendment
	34, // 10: vega.events.v1.TxErrorEvent.order_cancellation:type_name -> vega.commands.v1.OrderCancellation
	35, // 11: vega.events.v1.TxErrorEvent.proposal:type_name -> vega.commands.v1.ProposalSubmission
	36, // 12: vega.events.v1.TxErrorEvent.vote_submission:type_name -> vega.commands.v1.VoteSubmission
	37, // 13: vega.events.v1.TxErrorEvent.liquidity_provision_submission:type_name -> vega.commands.v1.LiquidityProvisionSubmission
	38, // 14: vega.events.v1.TxErrorEvent.withdraw_submission:type_name -> vega.commands.v1.WithdrawSubmission
	39, // 15: vega.events.v1.TxErrorEvent.delegate_submission:type_name -> vega.commands.v1.DelegateSubmission
	40, // 16: vega.events.v1.TxErrorEvent.undelegate_submission:type_name -> vega.commands.v1.UndelegateSubmission
	41, // 17: vega.events.v1.TxErrorEvent.restore_snapshot:type_name -> vega.commands.v1.RestoreSnapshot
	42, // 18: vega.events.v1.TxErrorEvent.liquidity_provision_cancellation:type_name -> vega.commands.v1.LiquidityProvisionCancellation
	43, // 19: vega.events.v1.TxErrorEvent.liquidity_provision_amendment:type_name -> vega.commands.v1.LiquidityProvisionAmendment
	44, // 20: vega.events.v1.TxErrorEvent.transfer:type_name -> vega.commands.v1.Transfer
	45, // 21: vega.events.v1.TxErrorEvent.cancel_transfer:type_name -> vega.commands.v1.CancelTransfer
	46, // 22: vega.events.v1.EpochEvent.action:type_name -> vega.EpochAction
	47, // 23: vega.events.v1.TransferResponses.responses:type_name -> vega.TransferResponse
	20, // 24: vega.events.v1.SettlePosition.trade_settlements:type_name -> vega.events.v1.TradeSettlement
	48, // 25: vega.events.v1.AuctionEvent.trigger:type_name -> vega.AuctionTrigger
	48, // 26: vega.events.v1.AuctionEvent.extension_trigger:type_name -> vega.AuctionTrigger
	...
	49, // 31: vega.events.v1.BusEvent.order:type_name -> vega.Order
	50, // 32: vega.events.v1.BusEvent.account:type_name -> vega.Account
	51, // 33: vega.events.v1.BusEvent.party:type_name -> vega.Party
	52, // 34: vega.events.v1.BusEvent.trade:type_name -> vega.Trade
	53, // 35: vega.events.v1.BusEvent.margin_levels:type_name -> vega.MarginLevels
	54, // 36: vega.events.v1.BusEvent.proposal:type_name -> vega.Proposal
	55, // 37: vega.events.v1.BusEvent.vote:type_name -> vega.Vote
	56, // 38: vega.events.v1.BusEvent.market_data:type_name -> vega.MarketData
	57, // 39: vega.events.v1.BusEvent.node_signature:type_name -> vega.commands.v1.NodeSignature
	...
	58, // 43: vega.events.v1.BusEvent.market_created:type_name -> vega.Market
	59, // 44: vega.events.v1.BusEvent.asset:type_name -> vega.Asset
	23, // 45: vega.events.v1.BusEvent.market_tick:type_name -> vega.events.v1.MarketTick
	60, // 46: vega.events.v1.BusEvent.withdrawal:type_name -> vega.Withdrawal
	61, // 47: vega.events.v1.BusEvent.deposit:type_name -> vega.Deposit
	24, // 48: vega.events.v1.BusEvent.auction:type_name -> vega.events.v1.AuctionEvent
	62, // 49: vega.events.v1.BusEvent.risk_factor:type_name -> vega.RiskFactor
	63, // 50: vega.events.v1.BusEvent.network_parameter:type_name -> vega.NetworkParameter
	64, // 51: vega.events.v1.BusEvent.liquidity_provision:type_name -> vega.LiquidityProvision
	58, // 52: vega.events.v1.BusEvent.market_updated:type_name -> vega.Market
	65, // 53: vega.events.v1.BusEvent.oracle_spec:type_name -> oracles.v1.OracleSpec
	66, // 54: vega.events.v1.BusEvent.oracle_data:type_name -> oracles.v1.OracleData
	...
	27, // 62: vega.events.v1.BusEvent.key_rotation:type_name -> vega.events.v1.KeyRotation
	28, // 63: vega.events.v1.BusEvent.state_var:type_name -> vega.events.v1.StateVar
	67, // 64: vega.events.v1.BusEvent.network_limits:type_name -> vega.NetworkLimits
	4,  // 65: vega.events.v1.BusEvent.transfer:type_name -> vega.events.v1.Transfer
	26, // 66: vega.events.v1.BusEvent.ranking_event:type_name -> vega.events.v1.ValidatorRankingEvent
	13, // 67: vega.events.v1.BusEvent.market:type_name -> vega.events.v1.MarketEvent
	14, // 68: vega.events.v1.BusEvent.tx_err_event:type_name -> vega.events.v1.TxErrorEvent
