...
func (LiquidityProvision_Status) EnumDescriptor() ([]byte, []int) {
	return file_vega_vega_proto_rawDescGZIP(), []int{36, 0}
}
...
var file_vega_vega_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x75, 0x65, 0x22, 0xd9, 0x03, 0x0a, 0x0d, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b,
	...
	0x12, 0x2d, 0x0a, 0x12, 0x62, 0x6f, 0x6f, 0x74, 0x73, 0x74, 0x72, 0x61, 0x70, 0x5f, 0x66, 0x69,
	0x6e, 0x69, 0x73, 0x68, 0x65, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x11, 0x62, 0x6f,
	0x6f, 0x74, 0x73, 0x74, 0x72, 0x61, 0x70, 0x46, 0x69, 0x6e, 0x69, 0x73, 0x68, 0x65, 0x64, 0x12,
	...
	0x65, 0x74, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x12, 0x32, 0x0a, 0x15, 0x62, 0x6f, 0x6f,
	0x74, 0x73, 0x74, 0x72, 0x61, 0x70, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x13, 0x62, 0x6f, 0x6f, 0x74, 0x73, 0x74,
	0x72, 0x61, 0x70, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x25, 0x0a,
	...
	0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xb5, 0x05, 0x0a,
	...
	0x28, 0x09, 0x52, 0x08, 0x74, 0x6d, 0x50, 0x75, 0x62, 0x4b, 0x65, 0x79, 0x12, 0x2b, 0x0a, 0x11,
	0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x5f, 0x61, 0x64, 0x64, 0x64, 0x72, 0x65, 0x73,
	0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75,
	0x6d, 0x41, 0x64, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x19, 0x0a, 0x08, 0x69, 0x6e, 0x66,
	...
	0x72, 0x55, 0x72, 0x6c, 0x22, 0xb8, 0x01, 0x0a, 0x08, 0x4e, 0x6f, 0x64, 0x65, 0x44, 0x61, 0x74,
	...
	0x10, 0x03, 0x2a, 0xde, 0x04, 0x0a, 0x0b, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x54, 0x79,
	...
	0x5f, 0x54, 0x41, 0x4b, 0x45, 0x52, 0x5f, 0x50, 0x41, 0x49, 0x44, 0x5f, 0x46, 0x45, 0x45, 0x53,
	...
	0x53, 0x10, 0x11, 0x2a, 0xa7, 0x06, 0x0a, 0x0c, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72,
	...
	0x5f, 0x44, 0x49, 0x53, 0x54, 0x52, 0x49, 0x42, 0x55, 0x54, 0x45, 0x10, 0x17, 0x2a, 0x63, 0x0a,
	...
	0x4e, 0x44, 0x49, 0x4e, 0x47, 0x10, 0x03, 0x42, 0x22, 0x5a, 0x20, 0x63, 0x6f, 0x64, 0x65, 0x2e,
...
var file_vega_vega_proto_msgTypes = make([]protoimpl.MessageInfo, 56)
var file_vega_vega_proto_goTypes = []interface{}{
	...
	(*Deposit)(nil),                       // 34: vega.Deposit
	(*Withdrawal)(nil),                    // 35: vega.Withdrawal
	(*WithdrawExt)(nil),                   // 36: vega.WithdrawExt
	(*Erc20WithdrawExt)(nil),              // 37: vega.Erc20WithdrawExt
	(*Account)(nil),                       // 38: vega.Account
	(*FinancialAmount)(nil),               // 39: vega.FinancialAmount
	(*Transfer)(nil),                      // 40: vega.Transfer
	(*TransferRequest)(nil),               // 41: vega.TransferRequest
	(*LedgerEntry)(nil),                   // 42: vega.LedgerEntry
	(*TransferBalance)(nil),               // 43: vega.TransferBalance
	(*TransferResponse)(nil),              // 44: vega.TransferResponse
	(*MarginLevels)(nil),                  // 45: vega.MarginLevels
	(*MarketData)(nil),                    // 46: vega.MarketData
	(*LiquidityProviderFeeShare)(nil),     // 47: vega.LiquidityProviderFeeShare
	(*PriceMonitoringBounds)(nil),         // 48: vega.PriceMonitoringBounds
	(*ErrorDetail)(nil),                   // 49: vega.ErrorDetail
	(*NetworkParameter)(nil),              // 50: vega.NetworkParameter
	(*NetworkLimits)(nil),                 // 51: vega.NetworkLimits
	...
	(*EthereumContractConfig)(nil),        // 56: vega.EthereumContractConfig
	...
	(*RankingScore)(nil),                  // 61: vega.RankingScore
	(*RewardScore)(nil),                   // 62: vega.RewardScore
...
var file_vega_vega_proto_depIdxs = []int32{
	...
	20, // 6: vega.Order.pegged_order:type_name -> vega.PeggedOrder
	21, // 7: vega.OrderCancellationConfirmation.order:type_name -> vega.Order
	21, // 8: vega.OrderConfirmation.order:type_name -> vega.Order
	25, // 9: vega.OrderConfirmation.trades:type_name -> vega.Trade
	21, // 10: vega.OrderConfirmation.passive_orders_affected:type_name -> vega.Order
	0,  // 11: vega.Trade.aggressor:type_name -> vega.Side
	14, // 12: vega.Trade.type:type_name -> vega.Trade.Type
	26, // 13: vega.Trade.buyer_fee:type_name -> vega.Fee
	26, // 14: vega.Trade.seller_fee:type_name -> vega.Fee
	25, // 15: vega.TradeSet.trades:type_name -> vega.Trade
	1,  // 16: vega.Candle.interval:type_name -> vega.Interval
	29, // 17: vega.MarketDepth.buy:type_name -> vega.PriceLevel
	29, // 18: vega.MarketDepth.sell:type_name -> vega.PriceLevel
	29, // 19: vega.MarketDepthUpdate.buy:type_name -> vega.PriceLevel
	29, // 20: vega.MarketDepthUpdate.sell:type_name -> vega.PriceLevel
	15, // 21: vega.Deposit.status:type_name -> vega.Deposit.Status
	16, // 22: vega.Withdrawal.status:type_name -> vega.Withdrawal.Status
	36, // 23: vega.Withdrawal.ext:type_name -> vega.WithdrawExt
	37, // 24: vega.WithdrawExt.erc20:type_name -> vega.Erc20WithdrawExt
	6,  // 25: vega.Account.type:type_name -> vega.AccountType
	39, // 26: vega.Transfer.amount:type_name -> vega.FinancialAmount
	7,  // 27: vega.Transfer.type:type_name -> vega.TransferType
	38, // 28: vega.TransferRequest.from_account:type_name -> vega.Account
	38, // 29: vega.TransferRequest.to_account:type_name -> vega.Account
	38, // 30: vega.TransferBalance.account:type_name -> vega.Account
	42, // 31: vega.TransferResponse.transfers:type_name -> vega.LedgerEntry
	43, // 32: vega.TransferResponse.balances:type_name -> vega.TransferBalance
	...
	48, // 36: vega.MarketData.price_monitoring_bounds:type_name -> vega.PriceMonitoringBounds
	47, // 37: vega.MarketData.liquidity_provider_fee_share:type_name -> vega.LiquidityProviderFeeShare
	...
	52, // 40: vega.LiquidityOrderReference.liquidity_order:type_name -> vega.LiquidityOrder
	53, // 41: vega.LiquidityProvision.sells:type_name -> vega.LiquidityOrderReference
	53, // 42: vega.LiquidityProvision.buys:type_name -> vega.LiquidityOrderReference
	17, // 43: vega.LiquidityProvision.status:type_name -> vega.LiquidityProvision.Status
	56, // 44: vega.EthereumConfig.collateral_bridge_contract:type_name -> vega.EthereumContractConfig
	56, // 45: vega.EthereumConfig.staking_bridge_contract:type_name -> vega.EthereumContractConfig
	56, // 46: vega.EthereumConfig.token_vesting_contract:type_name -> vega.EthereumContractConfig
	56, // 47: vega.EthereumConfig.multisig_control_contract:type_name -> vega.EthereumContractConfig
	57, // 48: vega.Epoch.timestamps:type_name -> vega.EpochTimestamps
	63, // 49: vega.Epoch.validators:type_name -> vega.Node
	65, // 50: vega.Epoch.delegations:type_name -> vega.Delegation
	58, // 51: vega.EpochParticipation.epoch:type_name -> vega.Epoch
	...
	60, // 55: vega.Node.epoch_data:type_name -> vega.EpochData
	8,  // 56: vega.Node.status:type_name -> vega.NodeStatus
	65, // 57: vega.Node.delegations:type_name -> vega.Delegation
	62, // 58: vega.Node.reward_score:type_name -> vega.RewardScore
	61, // 59: vega.Node.ranking_score:type_name -> vega.RankingScore
	69, // 60: vega.StateValueProposal.kvb:type_name -> vega.KeyValueBundle
	70, // 61: vega.KeyValueBundle.value:type_name -> vega.StateVarValue
	71, // 62: vega.StateVarValue.scalar_val:type_name -> vega.ScalarValue
	72, // 63: vega.StateVarValue.vector_val:type_name -> vega.VectorValue
	73, // 64: vega.StateVarValue.matrix_val:type_name -> vega.MatrixValue
	72, // 65: vega.MatrixValue.value:type_name -> vega.VectorValue
