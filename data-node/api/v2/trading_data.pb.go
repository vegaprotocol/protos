...
var file_data_node_api_v2_trading_data_proto_rawDesc = []byte{
	...
	0x01, 0x0a, 0x0f, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x69,
	...
	0x32, 0xf6, 0x13, 0x0a, 0x12, 0x54, 0x72, 0x61, 0x64, 0x69, 0x6e, 0x67, 0x44, 0x61, 0x74, 0x61,
...
var file_data_node_api_v2_trading_data_proto_msgTypes = make([]protoimpl.MessageInfo, 63)
var file_data_node_api_v2_trading_data_proto_goTypes = []interface{}{
	...
	(*OrderConnection)(nil),                              // 63: datanode.api.v2.OrderConnection
	(*vega.Order)(nil),                                   // 64: vega.Order
	(vega.AccountType)(0),                                // 65: vega.AccountType
	(*vega.MarketData)(nil),                              // 66: vega.MarketData
	(*vega.NetworkLimits)(nil),                           // 67: vega.NetworkLimits
	(*vega.Trade)(nil),                                   // 68: vega.Trade
	(*v1.OracleSpec)(nil),                                // 69: oracles.v1.OracleSpec
	(*v1.OracleData)(nil),                                // 70: oracles.v1.OracleData
...
var file_data_node_api_v2_trading_data_proto_depIdxs = []int32{
	...
	64, // 1: datanode.api.v2.GetOrdersByMarketResponse.orders:type_name -> vega.Order
	1,  // 2: datanode.api.v2.GetOrderVersionsByIDRequest.pagination:type_name -> datanode.api.v2.OffsetPagination
	63, // 3: datanode.api.v2.GetOrderVersionsByIDResponse.orders:type_name -> datanode.api.v2.OrderConnection
	2,  // 4: datanode.api.v2.GetOrdersByMarketPagedRequest.pagination:type_name -> datanode.api.v2.Pagination
	63, // 5: datanode.api.v2.GetOrdersByMarketPagedResponse.orders:type_name -> datanode.api.v2.OrderConnection
	2,  // 6: datanode.api.v2.GetOrdersByPartyPagedRequest.pagination:type_name -> datanode.api.v2.Pagination
	63, // 7: datanode.api.v2.GetOrdersByPartyPagedResponse.orders:type_name -> datanode.api.v2.OrderConnection
	2,  // 8: datanode.api.v2.GetOrderVersionsByIDPagedRequest.pagination:type_name -> datanode.api.v2.Pagination
	63, // 9: datanode.api.v2.GetOrderVersionsByIDPagedResponse.orders:type_name -> datanode.api.v2.OrderConnection
	...
	65, // 13: datanode.api.v2.AccountFilter.account_types:type_name -> vega.AccountType
	65, // 14: datanode.api.v2.AggregatedBalance.account_type:type_name -> vega.AccountType
	1,  // 15: datanode.api.v2.GetMarketDataHistoryByIDRequest.pagination:type_name -> datanode.api.v2.OffsetPagination
	66, // 16: datanode.api.v2.GetMarketDataHistoryByIDResponse.market_data:type_name -> vega.MarketData
	67, // 17: datanode.api.v2.GetNetworkLimitsResponse.limits:type_name -> vega.NetworkLimits
	...
	68, // 26: datanode.api.v2.TradeEdge.node:type_name -> vega.Trade
	...
	69, // 35: datanode.api.v2.GetOracleSpecByIDResponse.oracle_spec:type_name -> oracles.v1.OracleSpec
	2,  // 36: datanode.api.v2.ListOracleSpecsRequest.pagination:type_name -> datanode.api.v2.Pagination
	69, // 37: datanode.api.v2.ListOracleSpecsResponse.oracle_specs:type_name -> oracles.v1.OracleSpec
	2,  // 38: datanode.api.v2.GetOracleDataBySpecIDRequest.pagination:type_name -> datanode.api.v2.Pagination
	70, // 39: datanode.api.v2.GetOracleDataBySpecIDResponse.oracle_data:type_name -> oracles.v1.OracleData
	2,  // 40: datanode.api.v2.ListOracleDataRequest.pagination:type_name -> datanode.api.v2.Pagination
	70, // 41: datanode.api.v2.ListOracleDataResponse.oracle_data:type_name -> oracles.v1.OracleData
	...
	71, // 44: datanode.api.v2.MarketEdge.node:type_name -> vega.Market
	...
	72, // 49: datanode.api.v2.PartyEdge.node:type_name -> vega.Party
	...
	64, // 52: datanode.api.v2.OrderEdge.node:type_name -> vega.Order
	62, // 53: datanode.api.v2.OrderConnection.edges:type_name -> datanode.api.v2.OrderEdge
	3,  // 54: datanode.api.v2.OrderConnection.page_info:type_name -> datanode.api.v2.PageInfo
	4,  // 55: datanode.api.v2.TradingDataService.GetOrdersByMarket:input_type -> datanode.api.v2.GetOrdersByMarketRequest
	6,  // 56: datanode.api.v2.TradingDataService.GetOrderVersionsByID:input_type -> datanode.api.v2.GetOrderVersionsByIDRequest
	8,  // 57: datanode.api.v2.TradingDataService.GetOrdersByMarketPaged:input_type -> datanode.api.v2.GetOrdersByMarketPagedRequest
	10, // 58: datanode.api.v2.TradingDataService.GetOrdersByPartyPaged:input_type -> datanode.api.v2.GetOrdersByPartyPagedRequest
	12, // 59: datanode.api.v2.TradingDataService.GetOrderVersionsByIDPaged:input_type -> datanode.api.v2.GetOrderVersionsByIDPagedRequest
	14, // 60: datanode.api.v2.TradingDataService.GetBalanceHistory:input_type -> datanode.api.v2.GetBalanceHistoryRequest
	18, // 61: datanode.api.v2.TradingDataService.GetMarketDataHistoryByID:input_type -> datanode.api.v2.GetMarketDataHistoryByIDRequest
	20, // 62: datanode.api.v2.TradingDataService.GetNetworkLimits:input_type -> datanode.api.v2.GetNetworkLimitsRequest
	28, // 63: datanode.api.v2.TradingDataService.GetCandleData:input_type -> datanode.api.v2.GetCandleDataRequest
	26, // 64: datanode.api.v2.TradingDataService.SubscribeToCandleData:input_type -> datanode.api.v2.SubscribeToCandleDataRequest
	22, // 65: datanode.api.v2.TradingDataService.GetCandlesForMarket:input_type -> datanode.api.v2.GetCandlesForMarketRequest
	30, // 66: datanode.api.v2.TradingDataService.GetERC20MultiSigSignerAddedBundles:input_type -> datanode.api.v2.GetERC20MultiSigSignerAddedBundlesRequest
	33, // 67: datanode.api.v2.TradingDataService.GetERC20MultiSigSignerRemovedBundles:input_type -> datanode.api.v2.GetERC20MultiSigSignerRemovedBundlesRequest
	40, // 68: datanode.api.v2.TradingDataService.GetTradesByMarket:input_type -> datanode.api.v2.GetTradesByMarketRequest
	44, // 69: datanode.api.v2.TradingDataService.GetTradesByParty:input_type -> datanode.api.v2.GetTradesByPartyRequest
	42, // 70: datanode.api.v2.TradingDataService.GetTradesByOrderID:input_type -> datanode.api.v2.GetTradesByOrderIDRequest
	46, // 71: datanode.api.v2.TradingDataService.GetOracleSpecByID:input_type -> datanode.api.v2.GetOracleSpecByIDRequest
	48, // 72: datanode.api.v2.TradingDataService.ListOracleSpecs:input_type -> datanode.api.v2.ListOracleSpecsRequest
	50, // 73: datanode.api.v2.TradingDataService.GetOracleDataBySpecID:input_type -> datanode.api.v2.GetOracleDataBySpecIDRequest
	52, // 74: datanode.api.v2.TradingDataService.ListOracleData:input_type -> datanode.api.v2.ListOracleDataRequest
	54, // 75: datanode.api.v2.TradingDataService.GetMarkets:input_type -> datanode.api.v2.GetMarketsRequest
	58, // 76: datanode.api.v2.TradingDataService.GetParties:input_type -> datanode.api.v2.GetPartiesRequest
	5,  // 77: datanode.api.v2.TradingDataService.GetOrdersByMarket:output_type -> datanode.api.v2.GetOrdersByMarketResponse
	7,  // 78: datanode.api.v2.TradingDataService.GetOrderVersionsByID:output_type -> datanode.api.v2.GetOrderVersionsByIDResponse
	9,  // 79: datanode.api.v2.TradingDataService.GetOrdersByMarketPaged:output_type -> datanode.api.v2.GetOrdersByMarketPagedResponse
	11, // 80: datanode.api.v2.TradingDataService.GetOrdersByPartyPaged:output_type -> datanode.api.v2.GetOrdersByPartyPagedResponse
	13, // 81: datanode.api.v2.TradingDataService.GetOrderVersionsByIDPaged:output_type -> datanode.api.v2.GetOrderVersionsByIDPagedResponse
	15, // 82: datanode.api.v2.TradingDataService.GetBalanceHistory:output_type -> datanode.api.v2.GetBalanceHistoryResponse
	19, // 83: datanode.api.v2.TradingDataService.GetMarketDataHistoryByID:output_type -> datanode.api.v2.GetMarketDataHistoryByIDResponse
	21, // 84: datanode.api.v2.TradingDataService.GetNetworkLimits:output_type -> datanode.api.v2.GetNetworkLimitsResponse
	29, // 85: datanode.api.v2.TradingDataService.GetCandleData:output_type -> datanode.api.v2.GetCandleDataResponse
	27, // 86: datanode.api.v2.TradingDataService.SubscribeToCandleData:output_type -> datanode.api.v2.SubscribeToCandleDataResponse
	24, // 87: datanode.api.v2.TradingDataService.GetCandlesForMarket:output_type -> datanode.api.v2.GetCandlesForMarketResponse
	31, // 88: datanode.api.v2.TradingDataService.GetERC20MultiSigSignerAddedBundles:output_type -> datanode.api.v2.GetERC20MultiSigSignerAddedBundlesResponse
	34, // 89: datanode.api.v2.TradingDataService.GetERC20MultiSigSignerRemovedBundles:output_type -> datanode.api.v2.GetERC20MultiSigSignerRemovedBundlesResponse
	41, // 90: datanode.api.v2.TradingDataService.GetTradesByMarket:output_type -> datanode.api.v2.GetTradesByMarketResponse
	45, // 91: datanode.api.v2.TradingDataService.GetTradesByParty:output_type -> datanode.api.v2.GetTradesByPartyResponse
	43, // 92: datanode.api.v2.TradingDataService.GetTradesByOrderID:output_type -> datanode.api.v2.GetTradesByOrderIDResponse
	47, // 93: datanode.api.v2.TradingDataService.GetOracleSpecByID:output_type -> datanode.api.v2.GetOracleSpecByIDResponse
	49, // 94: datanode.api.v2.TradingDataService.ListOracleSpecs:output_type -> datanode.api.v2.ListOracleSpecsResponse
	51, // 95: datanode.api.v2.TradingDataService.GetOracleDataBySpecID:output_type -> datanode.api.v2.GetOracleDataBySpecIDResponse
	53, // 96: datanode.api.v2.TradingDataService.ListOracleData:output_type -> datanode.api.v2.ListOracleDataResponse
	55, // 97: datanode.api.v2.TradingDataService.GetMarkets:output_type -> datanode.api.v2.GetMarketsResponse
	59, // 98: datanode.api.v2.TradingDataService.GetParties:output_type -> datanode.api.v2.GetPartiesResponse
