...
var file_data_node_api_v2_trading_data_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x22, 0xbe, 0x02, 0x0a, 0x11, 0x41, 0x67, 0x67, 0x72,
	...
	0x61, 0x72, 0x6b, 0x65, 0x74, 0x5f, 0x69, 0x64, 0x22, 0x9e, 0x01, 0x0a, 0x0d, 0x41, 0x63, 0x63,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x73, 0x2a, 0xb0, 0x01, 0x0a, 0x0c, 0x41, 0x63,
...
var file_data_node_api_v2_trading_data_proto_goTypes = []interface{}{
	...
	(*AggregatedBalance)(nil),           // 3: datanode.api.v2.AggregatedBalance
	(*AccountFilter)(nil),               // 4: datanode.api.v2.AccountFilter
	(vega.AccountType)(0),               // 5: vega.AccountType
}
var file_data_node_api_v2_trading_data_proto_depIdxs = []int32{
	4, // 0: datanode.api.v2.QueryBalanceHistoryRequest.filter:type_name -> datanode.api.v2.AccountFilter
	0, // 1: datanode.api.v2.QueryBalanceHistoryRequest.group_by:type_name -> datanode.api.v2.AccountField
	3, // 2: datanode.api.v2.QueryBalanceHistoryResponse.balances:type_name -> datanode.api.v2.AggregatedBalance
	5, // 3: datanode.api.v2.AggregatedBalance.account_type:type_name -> vega.AccountType
	5, // 4: datanode.api.v2.AccountFilter.account_types:type_name -> vega.AccountType
...
func file_data_node_api_v2_trading_data_proto_init() {
	...
	file_data_node_api_v2_trading_data_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
