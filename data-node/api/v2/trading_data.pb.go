...
var file_data_node_api_v2_trading_data_proto_rawDesc = []byte{
	...
	0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x5f, 0x69, 0x64, 0x22, 0xbc, 0x01, 0x0a, 0x1f, 0x47, 0x65,
	...
	0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x55, 0x0a, 0x20, 0x47, 0x65, 0x74, 0x4d,
	...
	0x10, 0x05, 0x32, 0x89, 0x02, 0x0a, 0x12, 0x54, 0x72, 0x61, 0x64, 0x69, 0x6e, 0x67, 0x44, 0x61,
	0x74, 0x61, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x72, 0x0a, 0x13, 0x51, 0x75, 0x65,
	...
	0x74, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x44, 0x61, 0x74, 0x61, 0x48, 0x69, 0x73, 0x74, 0x6f,
	0x72, 0x79, 0x42, 0x79, 0x49, 0x44, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x2e,
...
var file_data_node_api_v2_trading_data_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_data_node_api_v2_trading_data_proto_goTypes = []interface{}{
	...
	(*GetMarketDataHistoryByIDRequest)(nil),  // 5: datanode.api.v2.GetMarketDataHistoryByIDRequest
	(*GetMarketDataHistoryByIDResponse)(nil), // 6: datanode.api.v2.GetMarketDataHistoryByIDResponse
	(vega.AccountType)(0),                    // 7: vega.AccountType
	(*vega.MarketData)(nil),                  // 8: vega.MarketData
}
var file_data_node_api_v2_trading_data_proto_depIdxs = []int32{
	...
	7, // 3: datanode.api.v2.AccountFilter.account_types:type_name -> vega.AccountType
	7, // 4: datanode.api.v2.AggregatedBalance.account_type:type_name -> vega.AccountType
	8, // 5: datanode.api.v2.GetMarketDataHistoryByIDResponse.market_data:type_name -> vega.MarketData
	1, // 6: datanode.api.v2.TradingDataService.QueryBalanceHistory:input_type -> datanode.api.v2.QueryBalanceHistoryRequest
	5, // 7: datanode.api.v2.TradingDataService.GetMarketDataHistoryByID:input_type -> datanode.api.v2.GetMarketDataHistoryByIDRequest
	2, // 8: datanode.api.v2.TradingDataService.QueryBalanceHistory:output_type -> datanode.api.v2.QueryBalanceHistoryResponse
	6, // 9: datanode.api.v2.TradingDataService.GetMarketDataHistoryByID:output_type -> datanode.api.v2.GetMarketDataHistoryByIDResponse
