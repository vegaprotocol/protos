...
var file_data_node_api_v2_trading_data_proto_rawDesc = []byte{
	...
	0x05, 0x32, 0xf2, 0x20, 0x0a, 0x12, 0x54, 0x72, 0x61, 0x64, 0x69, 0x6e, 0x67, 0x44, 0x61, 0x74,
...
var file_data_node_api_v2_trading_data_proto_depIdxs = []int32{
	...
	56,  // 139: datanode.api.v2.TradingDataService.GetERC20ListAssetBundle:input_type -> datanode.api.v2.GetERC20ListAssetBundleRequest
	60,  // 140: datanode.api.v2.TradingDataService.GetTradesByMarket:input_type -> datanode.api.v2.GetTradesByMarketRequest
	64,  // 141: datanode.api.v2.TradingDataService.GetTradesByParty:input_type -> datanode.api.v2.GetTradesByPartyRequest
	62,  // 142: datanode.api.v2.TradingDataService.GetTradesByOrderID:input_type -> datanode.api.v2.GetTradesByOrderIDRequest
	66,  // 143: datanode.api.v2.TradingDataService.GetOracleSpecByID:input_type -> datanode.api.v2.GetOracleSpecByIDRequest
	68,  // 144: datanode.api.v2.TradingDataService.ListOracleSpecs:input_type -> datanode.api.v2.ListOracleSpecsRequest
	70,  // 145: datanode.api.v2.TradingDataService.GetOracleDataBySpecID:input_type -> datanode.api.v2.GetOracleDataBySpecIDRequest
	72,  // 146: datanode.api.v2.TradingDataService.ListOracleData:input_type -> datanode.api.v2.ListOracleDataRequest
	74,  // 147: datanode.api.v2.TradingDataService.GetOracleSpecsConnection:input_type -> datanode.api.v2.GetOracleSpecsConnectionRequest
	76,  // 148: datanode.api.v2.TradingDataService.GetOracleDataConnection:input_type -> datanode.api.v2.GetOracleDataConnectionRequest
	82,  // 149: datanode.api.v2.TradingDataService.GetMarkets:input_type -> datanode.api.v2.GetMarketsRequest
	86,  // 150: datanode.api.v2.TradingDataService.GetParties:input_type -> datanode.api.v2.GetPartiesRequest
	91,  // 151: datanode.api.v2.TradingDataService.GetMarginLevels:input_type -> datanode.api.v2.GetMarginLevelsRequest
	98,  // 152: datanode.api.v2.TradingDataService.GetRewards:input_type -> datanode.api.v2.GetRewardsRequest
	96,  // 153: datanode.api.v2.TradingDataService.GetRewardSummaries:input_type -> datanode.api.v2.GetRewardSummariesRequest
	102, // 154: datanode.api.v2.TradingDataService.GetDeposits:input_type -> datanode.api.v2.GetDepositsRequest
	106, // 155: datanode.api.v2.TradingDataService.GetWithdrawals:input_type -> datanode.api.v2.GetWithdrawalsRequest
	110, // 156: datanode.api.v2.TradingDataService.GetAssets:input_type -> datanode.api.v2.GetAssetsRequest
	114, // 157: datanode.api.v2.TradingDataService.GetLiquidityProvisions:input_type -> datanode.api.v2.GetLiquidityProvisionsRequest
	5,   // 158: datanode.api.v2.TradingDataService.GetOrdersByMarket:output_type -> datanode.api.v2.GetOrdersByMarketResponse
	7,   // 159: datanode.api.v2.TradingDataService.GetOrderVersionsByID:output_type -> datanode.api.v2.GetOrderVersionsByIDResponse
	9,   // 160: datanode.api.v2.TradingDataService.GetOrdersByMarketConnection:output_type -> datanode.api.v2.GetOrdersByMarketConnectionResponse
	11,  // 161: datanode.api.v2.TradingDataService.GetOrdersByPartyConnection:output_type -> datanode.api.v2.GetOrdersByPartyConnectionResponse
	13,  // 162: datanode.api.v2.TradingDataService.GetOrderVersionsByIDConnection:output_type -> datanode.api.v2.GetOrderVersionsByIDConnectionResponse
	15,  // 163: datanode.api.v2.TradingDataService.GetPositionsByPartyConnection:output_type -> datanode.api.v2.GetPositionsByPartyConnectionResponse
	19,  // 164: datanode.api.v2.TradingDataService.GetBalanceHistory:output_type -> datanode.api.v2.GetBalanceHistoryResponse
	23,  // 165: datanode.api.v2.TradingDataService.GetMarketDataHistoryByID:output_type -> datanode.api.v2.GetMarketDataHistoryByIDResponse
	27,  // 166: datanode.api.v2.TradingDataService.MarketsDataSubscribe:output_type -> datanode.api.v2.MarketsDataSubscribeResponse
	29,  // 167: datanode.api.v2.TradingDataService.GetTransfers:output_type -> datanode.api.v2.GetTransfersResponse
	33,  // 168: datanode.api.v2.TradingDataService.GetNetworkLimits:output_type -> datanode.api.v2.GetNetworkLimitsResponse
	41,  // 169: datanode.api.v2.TradingDataService.GetCandleData:output_type -> datanode.api.v2.GetCandleDataResponse
	39,  // 170: datanode.api.v2.TradingDataService.SubscribeToCandleData:output_type -> datanode.api.v2.SubscribeToCandleDataResponse
	36,  // 171: datanode.api.v2.TradingDataService.GetCandlesForMarket:output_type -> datanode.api.v2.GetCandlesForMarketResponse
	45,  // 172: datanode.api.v2.TradingDataService.ListVotes:output_type -> datanode.api.v2.ListVotesResponse
	49,  // 173: datanode.api.v2.TradingDataService.ObserveVotes:output_type -> datanode.api.v2.ObserveVotesResponse
	51,  // 174: datanode.api.v2.TradingDataService.GetERC20MultiSigSignerAddedBundles:output_type -> datanode.api.v2.GetERC20MultiSigSignerAddedBundlesResponse
	54,  // 175: datanode.api.v2.TradingDataService.GetERC20MultiSigSignerRemovedBundles:output_type -> datanode.api.v2.GetERC20MultiSigSignerRemovedBundlesResponse
	57,  // 176: datanode.api.v2.TradingDataService.GetERC20ListAssetBundle:output_type -> datanode.api.v2.GetERC20ListAssetBundleResponse
	61,  // 177: datanode.api.v2.TradingDataService.GetTradesByMarket:output_type -> datanode.api.v2.GetTradesByMarketResponse
	65,  // 178: datanode.api.v2.TradingDataService.GetTradesByParty:output_type -> datanode.api.v2.GetTradesByPartyResponse
	63,  // 179: datanode.api.v2.TradingDataService.GetTradesByOrderID:output_type -> datanode.api.v2.GetTradesByOrderIDResponse
	67,  // 180: datanode.api.v2.TradingDataService.GetOracleSpecByID:output_type -> datanode.api.v2.GetOracleSpecByIDResponse
	69,  // 181: datanode.api.v2.TradingDataService.ListOracleSpecs:output_type -> datanode.api.v2.ListOracleSpecsResponse
	71,  // 182: datanode.api.v2.TradingDataService.GetOracleDataBySpecID:output_type -> datanode.api.v2.GetOracleDataBySpecIDResponse
	73,  // 183: datanode.api.v2.TradingDataService.ListOracleData:output_type -> datanode.api.v2.ListOracleDataResponse
	75,  // 184: datanode.api.v2.TradingDataService.GetOracleSpecsConnection:output_type -> datanode.api.v2.GetOracleSpecsConnectionResponse
	77,  // 185: datanode.api.v2.TradingDataService.GetOracleDataConnection:output_type -> datanode.api.v2.GetOracleDataConnectionResponse
	83,  // 186: datanode.api.v2.TradingDataService.GetMarkets:output_type -> datanode.api.v2.GetMarketsResponse
	87,  // 187: datanode.api.v2.TradingDataService.GetParties:output_type -> datanode.api.v2.GetPartiesResponse
	92,  // 188: datanode.api.v2.TradingDataService.GetMarginLevels:output_type -> datanode.api.v2.GetMarginLevelsResponse
	99,  // 189: datanode.api.v2.TradingDataService.GetRewards:output_type -> datanode.api.v2.GetRewardsResponse
	97,  // 190: datanode.api.v2.TradingDataService.GetRewardSummaries:output_type -> datanode.api.v2.GetRewardSummariesResponse
	103, // 191: datanode.api.v2.TradingDataService.GetDeposits:output_type -> datanode.api.v2.GetDepositsResponse
	107, // 192: datanode.api.v2.TradingDataService.GetWithdrawals:output_type -> datanode.api.v2.GetWithdrawalsResponse
	111, // 193: datanode.api.v2.TradingDataService.GetAssets:output_type -> datanode.api.v2.GetAssetsResponse
	115, // 194: datanode.api.v2.TradingDataService.GetLiquidityProvisions:output_type -> datanode.api.v2.GetLiquidityProvisionsResponse
