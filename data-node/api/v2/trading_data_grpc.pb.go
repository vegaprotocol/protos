...
type TradingDataServiceClient interface {
	...
	GetCandleData(ctx context.Context, in *CandleDataRequest, opts ...grpc.CallOption) (*CandleDataResponse, error)
	// Subscribe to a stream of Candle updates
	SubscribeToCandleData(ctx context.Context, in *CandleSubscribeRequest, opts ...grpc.CallOption) (TradingDataService_SubscribeToCandleDataClient, error)
	// Gets all available intervals for a given market along with the corresponding candle id
	GetCandlesForMarket(ctx context.Context, in *CandlesForMarketRequest, opts ...grpc.CallOption) (*CandlesForMarketResponse, error)
}
...
func (c *tradingDataServiceClient) GetCandleData(ctx context.Context, in *CandleDataRequest, opts ...grpc.CallOption) (*CandleDataResponse, error) {
	out := new(CandleDataResponse)
...
func (c *tradingDataServiceClient) SubscribeToCandleData(ctx context.Context, in *CandleSubscribeRequest, opts ...grpc.CallOption) (TradingDataService_SubscribeToCandleDataClient, error) {
...
type TradingDataService_SubscribeToCandleDataClient interface {
	Recv() (*CandleSubscribeResponse, error)
	grpc.ClientStream
}
...
func (x *tradingDataServiceSubscribeToCandleDataClient) Recv() (*CandleSubscribeResponse, error) {
	m := new(CandleSubscribeResponse)
...
func (c *tradingDataServiceClient) GetCandlesForMarket(ctx context.Context, in *CandlesForMarketRequest, opts ...grpc.CallOption) (*CandlesForMarketResponse, error) {
	out := new(CandlesForMarketResponse)
...
type TradingDataServiceServer interface {
	...
	// Get candle data for a given candle id
	GetCandleData(context.Context, *CandleDataRequest) (*CandleDataResponse, error)
	// Subscribe to a stream of Candle updates
	SubscribeToCandleData(*CandleSubscribeRequest, TradingDataService_SubscribeToCandleDataServer) error
	// Gets all available intervals for a given market along with the corresponding candle id
	GetCandlesForMarket(context.Context, *CandlesForMarketRequest) (*CandlesForMarketResponse, error)
...
func (UnimplementedTradingDataServiceServer) GetCandleData(context.Context, *CandleDataRequest) (*CandleDataResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetCandleData not implemented")
}
func (UnimplementedTradingDataServiceServer) SubscribeToCandleData(*CandleSubscribeRequest, TradingDataService_SubscribeToCandleDataServer) error {
	return status.Errorf(codes.Unimplemented, "method SubscribeToCandleData not implemented")
}
func (UnimplementedTradingDataServiceServer) GetCandlesForMarket(context.Context, *CandlesForMarketRequest) (*CandlesForMarketResponse, error) {
...
func _TradingDataService_GetCandleData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TradingDataServiceServer).GetCandleData(ctx, req.(*CandleDataRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _TradingDataService_SubscribeToCandleData_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(CandleSubscribeRequest)
...
type TradingDataService_SubscribeToCandleDataServer interface {
	Send(*CandleSubscribeResponse) error
	grpc.ServerStream
}
...
func (x *tradingDataServiceSubscribeToCandleDataServer) Send(m *CandleSubscribeResponse) error {
...
func _TradingDataService_GetCandlesForMarket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CandlesForMarketRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TradingDataServiceServer).GetCandlesForMarket(ctx, req.(*CandlesForMarketRequest))
	}
	return interceptor(ctx, in, info, handler)
}
