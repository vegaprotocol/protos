...
func checkNewMarketChanges(change *types.ProposalTerms_NewMarket) Errors {
	...
	} else if changes.PositionDecimalPlaces >= 150 {
		errs.AddForProperty("proposal_submission.terms.change.new_market.changes.position_decimal_places", ErrMustBeLessThan150)
	}
